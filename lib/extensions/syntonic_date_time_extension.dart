...
extension SyntonicDateTimeExtension on DateTime {
  ...
  String toDate() {
    var formatter = new DateFormat((this.year == 0000) ? SyntonicDateAndTime.mm_dd_with_slash : SyntonicDateAndTime.yyyy_mm_dd_with_slash, SyntonicLanguage.japanese);
  ...
  String toDateMonthDay() {
    var formatter = new DateFormat( SyntonicDateAndTime.mm_dd_with_slash , SyntonicLanguage.japanese);
    var formatted = formatter.format(this);
    return formatted;
  }
  ...
  String toTime() {
    var formatter = new DateFormat(SyntonicDateAndTime.hh_mm_with_colon, SyntonicLanguage.japanese);
    var formatted = formatter.format(this);
    return formatted;
  }
  ...
  String toDateTime() {
    var formatter = new DateFormat(SyntonicDateAndTime.yyyy_mm_dd_with_slash_and_hh_mm_with_colon, SyntonicLanguage.japanese);
    var formatted = formatter.format(this);
    return formatted;
  }
  ...
  String toDayOfWeekMonthDay() {
    var formatter = new DateFormat(SyntonicDateAndTime.dayofweek_month_day, SyntonicLanguage.english);
    var formatted = formatter.format(this);
    return formatted;
  }
  ...
  String toDayOfWeek() {
    var formatter = new DateFormat(SyntonicDateAndTime.day_of_week, SyntonicLanguage.japanese);
    var formatted = formatter.format(this);
    return formatted;
  }
