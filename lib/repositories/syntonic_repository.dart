...
abstract class SyntonicRepository {
  ...
  Future<ErrorHandlerService<dynamic>>? createAll(
      {bool isSynchronous = false, Function()? onSucceeded, Function()? onFailed}) =>
  ...
  /// Get an all [Models].
  Future<ErrorHandlerService<dynamic>>? getAll({bool isSynchronous = false, Function()? onSucceeded, Function()? onFailed}) =>
      throw UnimplementedError();

  /// Get a [Model] by an any [Model.id].
  Future<ErrorHandlerService<dynamic>>? getById({bool isSynchronous = false, Function()? onSucceeded, Function()? onFailed}) =>
      throw UnimplementedError();

  /// Get a URL that download CSV file.
  Future<ErrorHandlerService<dynamic>>? getCsv({bool isSynchronous = false, Function()? onSucceeded, Function()? onFailed}) =>
      throw UnimplementedError();

  /// Get a URL that download PDF file.
  Future<ErrorHandlerService<dynamic>>? getPdf({bool isSynchronous = false, Function()? onSucceeded, Function()? onFailed}) =>
      throw UnimplementedError();
