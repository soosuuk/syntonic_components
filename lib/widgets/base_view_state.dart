...
class BaseViewState {
  ...
  BaseViewState copyWith(
    ...
    return BaseViewState._(isChangedAppBar: isChangedAppBar, isFloatingActionButtonExtended: isFloatingActionButtonExtended, height: height, tabBarHeight: tabBarHeight, isFloatingActionButtonVisible: isFloatingActionButtonVisible, isStickyingAppBar: isStickyingAppBar, currentTabIndex: currentTabIndex, isInitialized: isInitialized, needsInitialize: needsInitialize, isSkeletonLoadingApplied: isSkeletonLoadingApplied);}
}