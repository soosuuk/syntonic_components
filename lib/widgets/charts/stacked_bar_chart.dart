...
class SyntonicStackedBarChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Map<String, dynamic>> chartData = [
      ...
      {
        "units": 10,
        "color": Colors.purple.harmonizeWith(Theme.of(context).colorScheme.primary),
      },
      {
        "units": 70,
        "color": Colors.purpleAccent.harmonizeWith(Theme.of(context).colorScheme.primary),
      },
      {
        "units": 100,
    ...
    return Padding(
      ...
      child: ClipRRect(
        ...
        child: Stack(children: [Row(
          ...
          Padding(padding: EdgeInsets.only(right: 16), child: OverlineText(text: 'Total: JPY 120,300', textColor: Colors.white,),),
        ],
