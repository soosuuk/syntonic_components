  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: [
        Container(
            padding: EdgeInsets.symmetric(horizontal: isFilled ? 4 : 3, vertical: isFilled ? 4 : 3),
          // padding: EdgeInsets.only(left: 4, right: 4),
            ...
            child: Row(
              ...
              children: [
                ...
                onDeleted != null ? Row(
                  children: [
                    SizedBox(height: 12, child: VerticalDivider(color: _isDarkTheme ? Colors.white38 : Colors.black38)),
                    InkWell(
                      onTap: onDeleted,
                      child: Icon(Icons.close, size: 12, color: _isDarkTheme ? Colors.white38 : Colors.black38)),
                  ],
                ) : const SizedBox(),
              ],)),
          onTap != null ?
