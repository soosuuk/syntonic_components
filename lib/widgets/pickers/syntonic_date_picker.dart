...
class SyntonicDatePicker {
  ...
  Future<DateTime?> show(BuildContext context, DateTime? selectedDate,
      DateTime? minimumDate, DateTime? maximumDate, bool? hasEntryMode) {
    return showDatePicker(
      ...
      lastDate: (maximumDate != null)
          ? maximumDate
          : initialDate.withSomeDateTime(year: initialDate.year + 100),
      initialEntryMode: hasEntryMode == true
